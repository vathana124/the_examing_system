...
class Login extends AuthLogin
{
    ...
    public function authenticate(): ?LoginResponse
    {
        try {
            ...
            $this->addError('rate_limit', config('custom_translations.error_message.is_rate_limit'));
            return null;
        }
        ...
        if (! Filament::auth()->attempt($this->getCredentialsFromFormData($data), $data['remember'] ?? false)) {
            ...
            $this->addError('credentials',config('custom_translations.error_message.is_wrong_data'));
            return null;
        }
        ...
        if (
            ...
            $this->addError('authorization', config('custom_translations.error_message.is_not_authorized'));
            return null;
        }
    ...
    {
        return config('custom_translations.login.sub_heading').' | '. config('custom_translations.login.title');
    }
  ...
  //   {
  //       return config('custom_translations.login.sub_heading');
  //   }
